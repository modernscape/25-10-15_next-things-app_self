  ...
  return (
    <div className="flex pr-4 text-2xl">
      <div className="flex flex-col">
        <button onClick={() => setView("active")} className={style_btn} style={{ fontWeight: view === "active" ? "bold" : "normal" }}>
          <Menu />
          One Thing
        </button>
        <button onClick={() => setView("trashed")} className={style_btn} style={{ fontWeight: view === "trashed" ? "bold" : "normal" }}>
          <Trash />
          ゴミ箱
        </button>
      </div>
